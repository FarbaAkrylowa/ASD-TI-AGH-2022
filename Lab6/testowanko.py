...
class SortedArray:
    ...
    def insert(self, element):
        """Inserts provided element into the appropriate tree."""
        ...
        # Binary search for appropriate place and check if it already exists
    ...
    def search(self, element):
        """Calls search on the appropriate element of the array."""
        # Round to the nearest 0.5
        root_data = round(element)
        if element - root_data >= 0:
            root_data += 0.5
...
class Node:
    ...
    def search(self, element):
        """Returns true or false if the given value exists in the tree."""
        temp_node = self
        while (temp_node):
